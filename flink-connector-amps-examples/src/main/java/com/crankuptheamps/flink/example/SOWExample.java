...
public class SOWExample {
    ...
    private static void subscribeCommandTest(AMPSSource<MarketData> source, AMPSSink<String> sink) throws Exception {
        ...
        env.fromSource(source, WatermarkStrategy.noWatermarks(), "Subscribe Command Test")
            .process(new ProcessFunction<MarketData, String>() {
                @Override
                public void processElement(MarketData value, ProcessFunction<MarketData, String>.Context ctx, Collector<String> out) throws Exception {
                    Thread.sleep(100);
